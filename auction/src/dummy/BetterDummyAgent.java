...
public class BetterDummyAgent implements AuctionBehavior {
    ...
    public Long askPrice(Task task) {
        ...
        double cost = costEstimation(currentSolution, task, timeout_bid * 0.4);
        System.out.println("dummy estimated cost: " + cost);

        double ratio = 1.0 + (random.nextDouble() * 0.05 * task.id);
        double bid = ratio * cost;
